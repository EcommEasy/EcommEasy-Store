...
export default class Footer extends React.PureComponent {
	...
	render() {
		...
		const footerLogoUrl = themeSettings.footer_logo_url && themeSettings.footer_logo_url.length > 0 ? storeSettings.assetsBaseURL + '/assets/images/' + themeSettings.footer_logo_url : settings.logo;
